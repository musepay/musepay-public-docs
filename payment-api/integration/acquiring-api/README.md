...
{% hint style="info" %}
Payments can be underpaid, overpaid, or received after the address expires. Base fulfillment on the webhook or query result rather than the initial create-order response.
{% endhint %}
