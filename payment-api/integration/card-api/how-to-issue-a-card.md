...
*   Then use the [Top Up Card](../../reference/api-reference/card-api/card-account.md#top-up-card) endpoint. MusePay transfers the specified amount from your agent account to the selected card account.
